...
function FooterColumn({ title, links }: FooterColumnProps) {
  return (
    <div>
      <h3 className="text-base font-semibold mb-6 text-[var(--accent)] dark:text-white">
        {title}
      </h3>
  ...
  const columns: FooterColumnProps[] = [
    ...
    },
    {
      ...
      links: [
        {
          text: "Documentation",
          href: "https://github.com/LLRHook/checksinmyhead/blob/main/README.md",
        },
        {
          text: "Bug Reports",
          href: "https://github.com/LLRHook/checksinmyhead/issues",
        },
      ],
    },
    {
      ...
      links: [
        {
          text: "License",
          href: "https://github.com/LLRHook/checksinmyhead/blob/main/LICENSE",
        },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-16">
          <div className="lg:col-span-2">
            ...
            <p className="text-[var(--text-secondary)] mb-6 max-w-md">
              Spliq is an open source, privacy-first bill-splitting app. All
